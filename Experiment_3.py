...
exp3_scores_df.to_csv("exp3_scores.csv",index_label='i')
########################################################################
...
exp3_scores_df = pd.read_csv("exp3_scores.csv")
num_epsilon_values = 11
...
detection_power_df.to_csv("exp3_detection_power.csv",index=False)
#
########################################################################

# Plot detection power
import matplotlib.pyplot as plot
exp3_detection_power_df = pd.read_csv("exp3_detection_power.csv")
exp3_detection_power_df = exp3_detection_power_df.set_index('epsilon')
exp3_detection_power_df = exp3_detection_power_df.rename(columns={'rp2': 't = 2', 'rp3': 't = 3', 'rp10': 't = 10'})
exp3_detection_power_df.plot(kind='line', grid=True, style='.-', title='Detection power - q ~ Uniform[1-eps,1+eps]', ylabel='detection power', xlabel='signal strength (epsilon)')
plot.pause(1e-3)
plot.savefig('detection_power_exp3.pdf')
